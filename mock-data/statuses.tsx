...
export const statuses: Status[] = [
  { id: "backlog", name: "Pendiente", color: "#53565A", icon: BacklogIcon },
  { id: "to-do", name: "Por hacer", color: "#53565A", icon: ToDoIcon },
  {
    id: "in-progress",
    name: "En progreso",
    color: "#facc15",
  ...
  { id: "paused", name: "Pausado", color: "#0ea5e9", icon: PausedIcon },
  { id: "completed", name: "Completado", color: "#8b5cf6", icon: CompletedIcon },
];
